...
{
    /// <summary>
    /// The per-device editor: the keyboard picture of one profile plus the remap workflow of
    /// specs/10-apps-and-ui.md ("click an on-screen key — the key enters 'listening' state; the
    /// next physical keypress captured by the app becomes the new assignment").
    /// <para>
    ...
    /// </para>
    /// </summary>
    public sealed class DeviceEditorViewModel : EditorViewModelBase, IDisposable
    {
