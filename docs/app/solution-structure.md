...
`KinesisEdit.Core` currently contains the static domain-data layer (see [`domain-data.md`](domain-data.md)), the firmware module (see [`firmware.md`](firmware.md)), the v-Drive services (see [`vdrive.md`](vdrive.md)), and the settings engine (see [`settings.md`](settings.md)):
