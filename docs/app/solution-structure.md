...
- `Converters` — `EnumMatchConverter`, `MessageBoxIconToGlyphConverter`, `MenuItemToggleTypeConverter`: the enum → style-class/glyph/toggle-type mapping that keeps colors and control-theme detail in XAML.
